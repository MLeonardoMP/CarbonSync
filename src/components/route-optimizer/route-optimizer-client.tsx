...
export function RouteOptimizerClient() {
  const { role } = useUser();
  const [suggestions, setSuggestions] = useState<SuggestEmissionOptimizedRoutesOutput['suggestions']>([]);
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-3">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem><FormLabel>Cargo Weight (tons)</FormLabel><FormControl><Input type="number" placeholder="e.g., 20" {...field} /></FormControl><FormMessage /></FormItem>
                  )}
                />
                <FormField
                  control={form.control}
      ...
      <div className="lg:col-span-2">
        <h3 className="mb-4 text-xl font-semibold">Suggested Routes</h3>
